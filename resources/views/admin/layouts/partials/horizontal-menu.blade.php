                ...
                <a href="javascript:;" class="nav-link">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 1v22M17 5a5 5 0 0 0-5-4 5 5 0 0 0 0 10 5 5 0 0 1 0 10 5 5 0 0 1-5-4" />
                        </svg>
                        <span class="px-1">Currency</span>
                    </div>
                    <div class="right_arrow">
                        <svg class="h-4 w-4 rotate-90" width="16" height="16" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
    ...
    @if (auth()->check() && auth()->user()->hasRole('accountant'))
        ...
        @canany(['*accountant'])
            ...
            <li class="menu nav-item relative">
                ...
                <ul class="sub-menu">
                    @can('*accountant')
                        {{-- <li><a href="{{ route('admin.salaries.create') }}">Provide Salary</a></li> --}}
                        <li><a href="{{ route('admin.salaries.generate') }}">Generate Salary</a></li>
                        <li><a href="{{ route('admin.salaries.index') }}">Salary List</a></li>
                        <li><a href="{{ route('admin.commissions.index') }}">Comission List</a></li>
                    @endcan
                </ul>
            </li>
            ...
            <li class="menu nav-item relative">
                ...
                <ul class="sub-menu">
                    @can('*accountant')
                        ...
                        <li><a href="{{ route('admin.finance-categories.index') }}">Manage Categories</a></li>
                    @endcan
                </ul>
            </li>
            ...
            <li class="menu nav-item relative">
                <a href="javascript:;" class="nav-link">
                    <div class="flex items-center">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" class="shrink-0">
                            <path
                                d="M3 10V18C3 19.1046 3.89543 20 5 20H19C20.1046 20 21 19.1046 21 18V10M12 7V4M12 4L9 7M12 4L15 7"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M21 10H3L4 4H20L21 10Z" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                        <span class="px-1">Bank Details</span>
                    </div>
                    <div class="right_arrow">
                        <svg class="h-4 w-4 rotate-90" width="16" height="16" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                ...
                <ul class="sub-menu">
                    @can('*accountant')
                        <li><a href="{{ route('admin.office-accounts.create') }}">Add Account</a></li>
                        <li><a href="{{ route('admin.office-accounts.index') }}">Account List</a></li>
                    @endcan
                </ul>
            </li>
            ...
            <li class="menu nav-item relative">
                    ...
                    <div class="flex items-center">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                            ...
                            <path d="M7 10L12 15L17 10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M12 2V15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                ...
                <ul class="sub-menu">
                    @can('*accountant')
                        <li><a href="{{ route('admin.office-transactions.create') }}">Add Transaction</a></li>
                    @endcan
                    @can('*accountant')
                        <li><a href="{{ route('admin.office-transactions.index') }}">Transaction List</a></li>
                    @endcan
                </ul>
            </li>
            ...
            <li class="menu nav-item relative">
                ...
                <ul class="sub-menu">
                    @can('*accountant')
                        <li><a href="{{ route('admin.budgets.create') }}">Allocate Budget</a></li>
                    @endcan
                    @can('*accountant')
                        <li><a href="{{ route('admin.budgets.index') }}">Budget List</a></li>
                    @endcan
                </ul>
            </li>
            ...
            <li class="menu nav-item relative">
                <a href="javascript:;" class="nav-link">
                    <div class="flex items-center">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" class="shrink-0">
                            <path d="M20 7H4V21H20V7Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path
                ...
                <ul class="sub-menu">
                    @can('*accountant')
                        <li><a href="{{ route('admin.reports.summary') }}">Report Summary</a></li>
                    @endcan
                </ul>
            </li>
        @endcanany
