...
@section('content')
    ...
    <div class="panel mt-6">
        <div class="mb-5 flex flex-col gap-5 md:flex-row md:items-center">
            <form action="{{ route('admin.applications.index2') }}" method="GET"
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('admin.applications.index2') }}" class="btn btn-outline-danger">Reset</a>
                </div>
            </form>
        </div>
                    ...
                    <tbody>
                        @forelse($applications as $app)
                            <tr>
                                ...
                                <td class="font-bold">BDT {{ number_format($app->total_fee, 2) }}
                                </td>
                                <td>
                                    <span
                                ...
                                <td class="text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="{{ route('admin.applications.edit2', $app->id) }}"
