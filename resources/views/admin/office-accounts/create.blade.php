...
@section('title', 'Add Office Account')

@section('content')
    <div class="flex flex-wrap items-center justify-between gap-4">
        <h2 class="text-xl font-semibold uppercase">Add Office Account</h2>
    ...
    <div class="panel mt-6">
        <form action="{{ route('admin.office-accounts.store') }}" method="POST">
            @csrf
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div class="form-group">
                    ...
                    <select name="account_type" id="account_type" class="form-select" required>
                        ...
                        <option value="mfs" {{ old('account_type') == 'mfs' ? 'selected' : '' }}>MFS (bKash/Nagad/Rocket)
                        </option>
            ...
            <div class="mt-8 flex justify-end gap-4">
                ...
                <button type="submit" class="btn btn-primary px-10">Add Account</button>
            </div>
        </form>
    </div>
@endsection
