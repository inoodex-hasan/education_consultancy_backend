...
@section('content')
    ...
    <div class="panel mt-6">
        <form action="{{ route('admin.reports.balance-sheet') }}" method="GET" class="mb-5 flex flex-wrap items-center gap-4 no-print">
        ...
        <div class="text-center mb-8 border-b pb-4">
            ...
            <p class="text-gray-500 mt-1 uppercase text-sm">As of {{ \Carbon\Carbon::parse($asOfDate)->format('d F, Y') }}</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            ...
            <div class="space-y-6">
                <div>
                    <h4 class="text-lg font-bold uppercase bg-primary/10 p-3 rounded-lg flex justify-between items-center text-primary">
                        <span>Assets</span>
                    ...
                    <div class="mt-4 space-y-2 px-2">
                        @forelse($data['asset'] as $asset)
                            <div class="flex justify-between items-center py-2 border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                <div class="flex flex-col">
                                    <span class="font-medium text-gray-700 uppercase text-sm tracking-tight">{{ $asset->name }}</span>
                    ...
                    <div class="mt-4 flex justify-between items-center p-3 bg-gray-50 rounded-lg border-2 border-primary/20">
            ...
            <div class="space-y-10">
                {{-- Liabilities --}}
                <div>
                    <h4 class="text-lg font-bold uppercase bg-danger/10 p-3 rounded-lg flex justify-between items-center text-danger">
                    ...
                    <div class="mt-4 space-y-2 px-2">
                        @forelse($data['liability'] as $liability)
                            <div class="flex justify-between items-center py-2 border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                <div class="flex flex-col">
                                    <span class="font-medium text-gray-700 uppercase text-sm tracking-tight">{{ $liability->name }}</span>
                    ...
                    <div class="mt-4 flex justify-between items-center p-3 bg-gray-50 rounded-lg border-b-2 border-danger/20 font-bold">
                ...
                {{-- Equity --}}
                <div>
                    <h4 class="text-lg font-bold uppercase bg-success/10 p-3 rounded-lg flex justify-between items-center text-success">
                        <span>Equity</span>
                        <span class="text-sm font-normal">Amount (BDT)</span>
                    </h4>
                    ...
                    <div class="mt-4 space-y-2 px-2">
                        @foreach($data['equity'] as $equity)
                            <div class="flex justify-between items-center py-2 border-b border-gray-100">
                                <div class="flex flex-col">
                                    <span class="font-medium text-gray-700 uppercase text-sm tracking-tight">{{ $equity->name }}</span>
                        ...
                        <div class="flex justify-between items-center py-3 border-b-2 border-dotted border-success/30 bg-success/5 px-2 rounded mt-2">
                            <span class="font-bold text-success uppercase text-sm">Net Profit / (Loss) <span class="text-[10px] font-normal lowercase">(Current Period)</span></span>
                    ...
                    <div class="mt-4 flex justify-between items-center p-3 bg-gray-50 rounded-lg border-b-2 border-success/20 font-bold">
                ...
                {{-- Combined Footer --}}
                <div class="mt-6 flex justify-between items-center p-4 bg-gray-800 text-white rounded-lg shadow-xl shadow-gray-200">
        ...
        @if(!$isBalanced)
            <div class="mt-8 p-4 bg-danger/10 border border-danger/20 rounded-lg flex items-center gap-3 text-danger no-print">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>
                <div class="font-bold">
        ...
        @else
             <div class="mt-8 p-4 bg-success/5 border border-success/10 rounded-lg flex items-center justify-center gap-3 text-success/60 text-xs italic no-print">
